...
namespace APIResource.Infrastructure.Policies
{
    public class ClaimsExtender : IClaimsTransformation
    {
        ...
        public async Task<ClaimsPrincipal> TransformAsync(ClaimsPrincipal principal)
        {
            ...
            long organizationId = _identityService.GetOrganizationIdFromHeader();

            List<ActivityViewModel> userActivities = _identityService.GetUserActivities(organizationId, userEmail);
